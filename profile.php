...
?>
    ...
    <body>
        ...
        <div class="container">
        <temp class="reg_logop">
        <img src="img/logo_gym.png" alt="about-image-one" width="500" height="400" />
    </temp>         
                ...
                <div class="signin-signup">
                    ...
                    <form class="sign-in-form" method="post">
                        ...
                        ?>
                                ...
                                <input type="submit" id="submit" name="submit" value="Update" class="btn solid" />
